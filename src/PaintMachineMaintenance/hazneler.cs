...
namespace PaintMachineMaintenance
{
    public partial class hazneler : Form
    {
        ...
        private void EkleBttn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"pigMikt{hazneNo} TextBox bulunamadıı!", "Hata",
            ...
            {
                MessageBox.Show($"Hazne {hazneNo} için pigment bilgisi bulunamadıı!", "Hata",
        ...
        private void CikarBttn_Click(object sender, EventArgs e)
        {
            ...
            DialogResult result = MessageBox.Show(
                $"{hazne.PigmentIsim}\n{miktar} gr çıçıkarmak istediğinize emin misiniz?\n\nMevcut: {hazne.KalanMiktar} gr\nKalacak: {hazne.KalanMiktar - miktar} gr",
                "Onay",
        ...
        private void UpdateHazne(int index, string isim, int miktar)
        {
            ...
            if (progressBar == null)
            {
                // MessageBox.Show($"progressBar{index} bulunamadıı!");
                return;
            }

            if (pigm == null)
            {
                // MessageBox.Show($"pigm{index} bulunamadıı!");
                return;
            }
