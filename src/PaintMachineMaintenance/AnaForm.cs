...
namespace PaintMachineMaintenance
{
    public partial class AnaForm : Form
    {
                ...
                using (var dr = cmd.ExecuteReader())
                {
                    ...
                    if (dt.Rows.Count == 0)
                    {
                        var result = MessageBox.Show(
                            "Henüz hiç dükkan yok.\nŞimdi dükkan eklemek ister misiniz?",
                            "Dükkan Bulunamadı",
                        ...
                        if (result == DialogResult.Yes)
                        {
                            ...
                            // Form kapandıktan sonra tekrar doldur
                            DukkanlariDoldur();
                        }
        ...
        private void boyaYapBttn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen önce bir personel seçiniz!", "Uyarı",
        ...
        private void BakimUyarilariniGetir()
        {
            ...
            {
                MessageBox.Show("Bakım uyarıları alınamadı: " + ex.Message);
            }
        }
